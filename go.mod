...
require (
	...
	github.com/kubernetes-csi/external-provisioner/client v0.0.0-00010101000000-000000000000
...
replace (
	github.com/kubernetes-csi/external-provisioner/client => ./client
	...
	k8s.io/node-api => k8s.io/node-api v0.20.0
