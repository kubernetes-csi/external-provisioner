...
replace k8s.io/api => k8s.io/api v0.19.0-rc.2

replace k8s.io/apimachinery => k8s.io/apimachinery v0.19.0-rc.2

replace k8s.io/apiserver => k8s.io/apiserver v0.19.0-rc.2

replace k8s.io/client-go => k8s.io/client-go v0.19.0-rc.2

replace k8s.io/component-base => k8s.io/component-base v0.19.0-rc.2

replace k8s.io/controller-manager => k8s.io/controller-manager v0.19.0-rc.2

replace k8s.io/csi-translation-lib => k8s.io/csi-translation-lib v0.19.0-rc.2
