...
require (
	...
	k8s.io/csi-translation-lib v0.19.0-rc.1
	k8s.io/klog v1.0.0
...
replace k8s.io/api => k8s.io/api v0.19.0-rc.1

replace k8s.io/apimachinery => k8s.io/apimachinery v0.19.0-rc.1

replace k8s.io/apiserver => k8s.io/apiserver v0.19.0-rc.1

replace k8s.io/cli-runtime => k8s.io/cli-runtime v0.17.0

replace k8s.io/csi-translation-lib => k8s.io/csi-translation-lib v0.19.0-rc.1

replace k8s.io/cloud-provider => k8s.io/cloud-provider v0.19.0-rc.1

replace k8s.io/client-go => k8s.io/client-go v0.19.0-rc.1

replace k8s.io/component-base => k8s.io/component-base v0.19.0-rc.1
