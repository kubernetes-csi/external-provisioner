...
# Changelog since 6.1.1

## Changes by Kind

### Bug or Regression

- Add controller to clean up orphaned snapshot source-protection finalizers that can block snapshot deletion after provisioner crashes or PVC deletions. ([#1523](https://github.com/kubernetes-csi/external-provisioner/pull/1523), [@ConnorJC3](https://github.com/ConnorJC3))
