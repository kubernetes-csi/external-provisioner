...
var map_StorageClass = map[string]string{
	...
	"secretRefs":           "Secrets for authentication and authorization against a storage backend, which is described by the StorageClass object. CredentialID is the key, to select corresponding Secret.",
}
